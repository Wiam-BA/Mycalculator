    ...
    void MyCalculator::equals_button_clicked()
{
    ...
    float secondOperand = m_storedValue.toFloat();
    float result = 0.0;
...
// if I click on equal multiple times, the 2nd operand needs to remeber its last value and keep (adding it for example) to the variable result
// if I click on the "." button it needs to add a zero before automatically
